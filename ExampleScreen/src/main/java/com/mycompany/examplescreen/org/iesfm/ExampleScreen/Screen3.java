...
public class Screen3 extends javax.swing.JDialog {

    public Screen3(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Screen3 dialog = new Screen3(new javax.swing.JDialog(), true);
